...
=item The L<Datepicker Control|http://dali.mty.itesm.mx/~hugo/js/datepickercontrol/> for entering a date in the detail block.

=item Some L<SAP icons|http://www.sapdesignguild.org/resources/icons_sap/icons_d1_3.htm> for navigation (I<back>, I<cancel>, I<new>, I<delete row>, I<undo> and I<save>).
